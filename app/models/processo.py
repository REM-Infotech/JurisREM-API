...
class Processo(BaseModel):
    ...
    area_juridica = db.Column(db.String(100), nullable=False)  # civil, criminal, trabalhista, etc.
    ...
    prioridade = db.Column(db.String(20), default='normal', nullable=False)  # baixa, normal, alta, urgente
    ...
    def get_ultimo_andamento(self):
        ...
        from app.models.processo import Andamento  # Import local para evitar circular import
...
class Andamento(BaseModel):
    ...
    observacoes = db.Column(db.Text, nullable=True)
    documento_anexo = db.Column(db.String(500), nullable=True)  # caminho para arquivo anexo
