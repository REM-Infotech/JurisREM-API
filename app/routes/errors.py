"""Defina manipuladores de erro personalizados para a aplicação Flask."""
...
def register_error_handlers(app):
    """Registre manipuladores de erro personalizados na aplicação Flask.
    ...
    def handle_generic_exception(error):
        ...
        print(f"Exceção não tratada: {type(error).__name__}: {error}")
