...
def obter_advogado(advogado_id):
    ...
    try:
        ...
        return jsonify({
            ...
            'email': advogado.email,
            'telefone': advogado.telefone,
            'data_admissao': advogado.data_admissao.isoformat() if advogado.data_admissao else None,
            'data_demissao': advogado.data_demissao.isoformat() if advogado.data_demissao else None,
...
def atualizar_advogado(advogado_id):
    ...
    try:
        ...
        if ('oab_numero' in data and 'oab_estado' in data and 
            (data['oab_numero'] != advogado.oab_numero or 
             data['oab_estado'] != advogado.oab_estado)):
            if Advogado.query.filter_by(
                oab_numero=data['oab_numero'], 
                oab_estado=data['oab_estado']
            ).first():
        ...
        campos_atualizaveis = [
            'nome', 'cpf', 'oab_numero', 'oab_estado', 'email', 'telefone',
            'data_admissao', 'data_demissao', 'endereco_rua', 'endereco_numero',
            'endereco_complemento', 'endereco_bairro', 'endereco_cidade',
            'endereco_estado', 'endereco_cep', 'biografia', 'observacoes', 'ativo'
        ]
